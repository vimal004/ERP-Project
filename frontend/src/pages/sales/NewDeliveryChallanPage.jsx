...
/**
 * NewDeliveryChallanPage - Material Design 3 (Google Store Aesthetic)
 */
    ...
    >
      ...
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <TruckIcon className="w-5 h-5" style={{ color: "#1a73e8" }} />
            </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-5">
            ...
            <FormSelect
              ...
              onChange={handleInputChange}
            >
              <option value="">Choose challan type</option>
        ...
        <div>
          ...
          <div
            className="p-6 flex flex-col items-center justify-center cursor-pointer transition-all duration-200 hover:bg-gray-50"
