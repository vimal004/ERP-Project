...
const RecurringInvoicesPage = () => {
  ...
  const getStatusBadge = (status) => {
    const styles = {
      ...
      STOPPED: { bg: "#fce8e6", color: "#d93025" },
      EXPIRED: { bg: "#e8eaed", color: "#5f6368" },
    };
    ...
    <div className="p-6 sm:p-8">
      ...
      >
        ...
        >
          ...
          >
            <span className="w-[18%] px-4">Profile Name</span>
            <span className="w-[18%] px-4">Customer Name</span>
            <span className="w-[14%] px-4">Frequency</span>
          ...
          {loading ? (
            ...
            invoices.map((invoice) => (
              ...
              >
                <span
                  className="w-[18%] px-4 font-medium"
                  style={{ color: "#1a73e8" }}
                >
                  {invoice.profileName || "-"}
                </span>
                <span className="w-[18%] px-4">{invoice.customerName}</span>
                <span className="w-[14%] px-4" style={{ color: "#5f6368" }}>
